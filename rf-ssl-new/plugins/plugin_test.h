...
public:
  ...
  //isFirstRun - в первый раз применяем старый метод, далее новый
  //blueTeam, yellowTeam, currentBall - объекты, храняющие в себе информацию об объектах для последующего анализа
  bool isFirstRun;
