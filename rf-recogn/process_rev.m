...
pic_gray = GS(new_pic);
% Выделение кластеров:
% img - изображение с окружностями, окружающими кластеры
...
% Вектор с именами цветов
color = ['g','b','m','r'];

% Соответствия номеров кластеров цветам
...
%Выводим цвета, прошедшие проверку
